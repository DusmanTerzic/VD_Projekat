...
$(document).ready(function(){
    ...
    $("#logg").click(function(){
        ...
        if (passed == true){
            ...
            window.open("moj-nalog.html", "_self");
            }
            else{
                $("#logError").show();
                logged = false;
    ...
    $("#logout").click(function(){
        logged = false;
        localStorage.setItem("logged", JSON.stringify(logged));
        window.open("fitness-home.html", "_self");
    })
    $("#pocetna").click(function(){
        window.open("fitness-home.html", "_self");
    })
    $("#zakazivanje").click(function(){
        window.open("fitness-booking.html", "_self");
    })
    ...
    $("#about").click(function(){
        window.open("fitness-about.html", "_self");
    })
    $("#treninzi").click(function(){
        window.open("fitness-training.html", "_self");
    })
    $("#masnutr").click(function(){
        window.open("fitness-masnutr.html", "_self");
    })
    $("#acc").click(function(){
...
function pogledaj(element) {
    element.setAttribute('src', 'image6hover.png');
}
  
function nePogledaj(element) {
    element.setAttribute('src', 'image6.jpg');
}
...
function uclaniSe(element) {
    element.setAttribute('src', 'images4hover.png');
}
...
function print(){
    ...
    document.getElementById("pdf").innerHTML = "</br> <p> Ime:" + localStorage.getItem("ime") + "</p><p>Prezime: "+ localStorage.getItem("prezime") + "</p><p>E-mail:" + localStorage.getItem("email") + "</p><p>Datum:" + localStorage.getItem("datum")+ "</p><p>Telefon:" + localStorage.getItem("tel") + "<p></p>Opis problema:" + localStorage.getItem("opis") + "</p>";
    else
    document.getElementById("pdf2").innerHTML = "</br> <p> Ime:" + localStorage.getItem("ime") + "</p><p>Prezime: "+ localStorage.getItem("prezime") + "</p><p>E-mail:" + localStorage.getItem("email") + "</p><p>Datum:" + localStorage.getItem("datum")+ "</p><p>Telefon:" + localStorage.getItem("tel") + "<p></p>Opis problema:" + localStorage.getItem("opis") + "</p>";
